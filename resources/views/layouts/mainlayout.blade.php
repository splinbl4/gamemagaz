    ...
    <header class="main-header">
        ...
        <nav class="main-navigation">
            <ul class="nav-list">
                ...
                <li class="nav-list__item"><a href="{{ url('/samples/cart/step1') }}" class="nav-list__item__link">Мои заказы</a></li>
                <li class="nav-list__item"><a href="{{ url('/samples/news/list') }}" class="nav-list__item__link">Новости</a></li>
                <li class="nav-list__item"><a href="{{ url('/samples/about') }}" class="nav-list__item__link">О компании</a></li>
            </ul>
        </nav>
        ...
        <div class="header-container">
            ...
            @else
                <div class="authorization-block">{{ Auth::user()->name }}<a href="{{ url('/logout') }}" class="authorization-block__link">Выйти</a></div>
            @endif
        </div>
    </header>
    <div class="middle">
